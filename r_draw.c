...
// State.
#include "doomstat.h"
#include "st_stuff.h" // Size of statusbar.

void WriteDebug(char *);


// vrodic:18-03-98:this is the lumpname of the flat used to draw the window
//  borders when the viewwindow is diminished. It should be configurable
//  at the menu or somewhere else in the future.
char	borderpatchname[9];
...
void R_InitBuffer( int width, int height )
   { 
    ...
    if (width == SCREENWIDTH) 
        ...
        viewwindowy = (SCREENHEIGHT-ST_HEIGHT-height) >> 1; 
...
void R_FillBackScreen (void) 
   { 
    ...
    //vrodic:18-03-98:borderpatchname is set at ST_Init() now.
...
void R_DrawViewBorder (void) 
   { 
    ...
    if ((SCREENWIDTH > 320) && (SCREENHEIGHT != viewheight))
       {
        ofs = (SCREENHEIGHT-ST_HEIGHT) * SCREENWIDTH;
    ...
    top = ((SCREENHEIGHT-ST_HEIGHT)-viewheight)/2;
